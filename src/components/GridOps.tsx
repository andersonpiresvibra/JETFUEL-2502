...
export const GridOps: React.FC<GridOpsProps> = ({ flights, onUpdateFlights, vehicles, onNavigate }) => {
  ...
  const stats = useMemo(() => ({
    ...
    chegada: visibleFlights.filter(f => f.status === FlightStatus.CHEGADA).length,
  ...
  const filteredData = useMemo(() => {
    switch (activeTab) {
      case 'CHEGADA': return visibleFlights.filter(f => f.status === FlightStatus.CHEGADA);
      case 'FILA': 
        // REGRA DE OURO: ABA FILA NÃO PODE TER OPERADOR
        return visibleFlights.filter(f => f.status === FlightStatus.FILA && !f.operator);
      case 'DESIGNADOS': return visibleFlights.filter(f => f.status === FlightStatus.DESIGNADO);
      case 'ABASTECENDO': return visibleFlights.filter(f => f.status === FlightStatus.ABASTECENDO);
      case 'FINALIZADO': return visibleFlights.filter(f => f.status === FlightStatus.FINALIZADO || f.status === FlightStatus.CANCELADO);
      case 'GERAL': 
      ...
      default: return visibleFlights;
    }
  }, [activeTab, visibleFlights, archivedIds]);
              ...
              <div className="bg-slate-900 border border-slate-800 p-8 rounded-2xl w-[450px] shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                  ...
                  <div className="flex gap-4">
                      ...
                      <button 
                          ...
                          className="flex-1 bg-slate-800 hover:bg-slate-700 text-white font-black py-4 rounded-xl uppercase tracking-widest text-xs transition-all"
                      >
                          Não, Voltar
                      </button>
                  </div>
              ...
              <div className="bg-slate-900 border border-slate-800 p-8 rounded-2xl w-[450px] shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                  ...
                  <div className="flex gap-4">
                      <button 
                          ...
                          className="flex-1 bg-blue-600 hover:bg-blue-500 text-white font-black py-4 rounded-xl uppercase tracking-widest text-xs transition-all shadow-lg shadow-blue-600/20"
                      >
                          Sim, Iniciar
                      </button>
                      <button 
              ...
              <div className="bg-slate-900 border border-slate-800 p-8 rounded-2xl w-[450px] shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                  ...
                  <div className="flex gap-4">
                      <button 
                          ...
                          className="flex-1 bg-amber-600 hover:bg-amber-500 text-white font-black py-4 rounded-xl uppercase tracking-widest text-xs transition-all shadow-lg shadow-amber-600/20"
                      >
                          Sim, Remover
                      </button>
                      <button 
              ...
              <div className="bg-slate-900 border border-slate-800 p-8 rounded-2xl w-[450px] shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                  ...
                  <div className="flex gap-4">
                      <button 
                          ...
                          className="flex-1 bg-emerald-600 hover:bg-emerald-500 text-white font-black py-4 rounded-xl uppercase tracking-widest text-xs transition-all shadow-lg shadow-emerald-600/20"
                      >
                          Sim, Finalizar
                      </button>
                      <button 
